				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	component = snd_soc_dapm_kcontrol_to_component(kcontrol);
	cs35l43 = snd_soc_component_get_drvdata(component);
...
{
	struct snd_soc_dapm_context *dapm = snd_soc_component_to_dapm(cs35l43->component);
...
static const struct snd_soc_dai_ops cs35l43_compress_ops = {
